...
public class NervousShapes {
	...
	// /////////////////////////////////////////////////////////
	// NAME: createShapes
	// BEHAVIOR: Creates enough Circle and Rectangle and Triangle objects
	...
	private static void createShapes() {
		for (int i = 0; i < shapes.length; i++) {
			...
			// Decide whether to create a circle or a rectangle or a triangle
			if (Math.random() < 0.33) {
				...
				// Generate a triangle with a random size and
				// position
				int triSide = generateRandomInt(MIN_SIZE, MAX_SIZE);
				int x = generateRandomInt(0, WINDOW_SIZE - triSide);
				int y = generateRandomInt(0, WINDOW_SIZE - triSide);
				shapes[i] = new Triangle(x, y, color, triSide);
			}
		}
	}
